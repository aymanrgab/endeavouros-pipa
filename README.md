...
1. Build the Builder container:
   ...
   ```
   *Note: This step prepares the image builder. Device packages are fetched from the published `pipa-pkgs` pacman repository by default instead of being built locally.*
